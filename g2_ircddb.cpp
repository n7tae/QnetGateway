...
static int read_config(char *cfgFile)
{
   ...
   while (fgets(inbuf, 1020, cnf) != NULL)
   {
      ...
      *p = '\0';
      ...
      if (strcmp(inbuf,"TO_RPTR_IP_A") == 0)
      {
         ptr = strchr(p + 1, ' ');
         if (ptr)
            *ptr = '\0';
      ...
      if (strcmp(inbuf,"TO_RPTR_PORT_A") == 0)
      {
      ...
      if (strcmp(inbuf,"TO_RPTR_IP_B") == 0)
      {
         ptr = strchr(p + 1, ' ');
         if (ptr)
            *ptr = '\0';
      ...
      if (strcmp(inbuf,"TO_RPTR_PORT_B") == 0)
      {
      ...
      if (strcmp(inbuf,"TO_RPTR_IP_C") == 0)
      {
         ptr = strchr(p + 1, ' ');
         if (ptr)
            *ptr = '\0';
      ...
      if (strcmp(inbuf,"TO_RPTR_PORT_C") == 0)
      {
